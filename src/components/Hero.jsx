      ...
      <div className={`${styles.paddingX} z-10 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <div className="mt-4 z-10 relative">
            <a href="https://drive.google.com/drive/folders/1M2DTPWVCqGKhttux_TDPE-j7HnBDTbIa?usp=sharing" target="_blank" rel="noopener noreferrer" className="inline-block">
