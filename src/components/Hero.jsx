      ...
      <div className={`${styles.paddingX} z-10 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <div className="mt-4 z-10 relative">
            <a href="https://binusianorg-my.sharepoint.com/personal/mario007_binus_ac_id/_layouts/15/guestaccess.aspx?share=EY7tlNJO8mNFpQbE5PkRSpQBt3jDsobFV2zRdM6IjH-Wag&e=7Gicw8" target="_blank" rel="noopener noreferrer" className="inline-block">
