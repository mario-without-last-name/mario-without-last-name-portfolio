      ...
      <div className={`${styles.paddingX} z-10 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <div className="mt-4 z-10 relative">
            <a href="https://binusianorg-my.sharepoint.com/personal/mario007_binus_ac_id/_layouts/15/guestaccess.aspx?share=EWwevwF7ms5AjYwdjSYvVr4BFm4GWneBjGLwWPRH8iEFdA&e=R9ijCH" target="_blank" rel="noopener noreferrer" className="inline-block">
